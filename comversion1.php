...
<html lang="en">
    ...
    <body style="background-color: #9292b9;">
        <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark static-top" style="background-color: #87d899">
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <strong><h2 style="color: black;">CONVERSIÓN DE DOLARES A PESOS MEXICANOS</h2></strong>
                    </div>
                </div>
                <br>
                <div class="card" style="background-color: #87d899;">
                    <div class="card-body">
                            ...
                            <label for=""><h6 style="color: black;">MONTO A CONVERTIR</h6></label>
                    ...
                    <div class="row">
                        <div class="col-sm-6 text-center">
                            ...
                            <span class="btn btn-warning btn-block" id="limpiar">Limpiar</span>
                        </div>
                        <div class="col text-center">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#calcular').click(function(){
            ...
            let resultado = cantidad*20;
            
            resultado = resultado+"";

            $('#resultado').text( "La cantidad ingresada en pesos mexicanos es" + " "+ "$" + resultado);
