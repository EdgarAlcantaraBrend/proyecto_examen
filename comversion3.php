...
<html lang="en">
    ...
    <body style="background-color: #d8b3d2;" >
        <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark static-top" style="background-color: #b37bc3">
            <div class="container">
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color: #d8b3d2;" >
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <strong><h2 style="color: black;">CONVERSIÓN DE CENTIMETROS A METROS</h2></strong>
                    </div>
                </div>
                <br>
                <div class="card" style="background-color: #b37bc3;">
                    <div class="card-body">
                        <label for=""><h6 style="color: black;">CENTIMETROS A CONVERTIR</h6></label>
...
<script>
    $(document).ready(function(){
        ...
        $('#calcular').click(function(){
            ...
            let resultado =  cantidad/ 100; 

            $('#resultado').text("El resultado de los centimetros ingresados es:" + " " + resultado);
        });
