...
<html lang="en">
    ...
    <body style="background-color: #9d7caf">
        <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark static-top" style="background-color: #9d7caf">
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <strong><h2 style="color:white">CONVERSIÓN DE LIBRAS A KILOGRAMOS</h2></strong>
                    </div>
                </div>
                <br>
                <div class="card" style="background-color: #b170c3">
                    <div class="card-body">
                        <label for=""><h6 style="color: black;">LIBRAS A CONVERTIR</h6></label>
                        ...
                        <div class="row">
                            <div class="col-sm-6 text-center">
                                <button class="btn btn-danger btn-block" id="calcular">Calcular</button>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#calcular').click(function(){
            ...
            let resultado =  cantidad/2.205;

            resultado = resultado+"";

            $('#resultado').text("Las libras ingresadas equivales a:"+" "+resultado+" "+"kilogramos");
        });
